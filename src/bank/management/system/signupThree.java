...
public class signupThree extends JFrame implements ActionListener {
    ...
    signupThree(String formno) {
        ...
        accountDetails.setBounds(270,90,300,30);
        add(accountDetails);

        JLabel type = new JLabel("Account Type");
        type.setFont(new Font("Raleway", Font.BOLD, 18));
        type.setBounds(80,140,300,30);
        add(type);
        ...
        savingsAccount.setBounds(80,170,200,30);
        add(savingsAccount);
        ...
        fixedDeposite.setBounds(300,170,300,30);
        add(fixedDeposite);

        currentAccount = new JRadioButton("Current Account");
        currentAccount.setFont(new Font("Raleway", Font.BOLD, 18));
        currentAccount.setBackground(Color.WHITE);
        currentAccount.setBounds(80,200,200,30);
        add(currentAccount);
        ...
        recurringAccount.setBounds(300,200,300,30);
        ...
        cardDetail.setBounds(80,260,300,30);
        add(cardDetail);
        ...
        pinNumber.setBounds(300,300,300,30);
        add(pinNumber);
        ...
        submit.setBounds(440,570,100,30);
